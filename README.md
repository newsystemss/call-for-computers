...
A custom multi-step web form for collecting submissions from people exploring how computers can be used in unique and new ways. Built as a standalone static site intended to be deployed at computer.newsystems.ca.
...
- **Domain:** computer.newsystems.ca (CNAME to Netlify)
