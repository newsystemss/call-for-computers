# Claude Code Project Guide: New Casting Call

## Overview

Custom submission form for casting subjects who are exploring how computers can be used in unique and new ways. Static HTML/CSS/JS frontend posting to a Google Apps Script backend. Intended to be deployed at casting.newsystems.ca via Netlify.
